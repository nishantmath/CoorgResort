...
//#endregion
//#region node_modules/react-router/dist/development/lib/router/matcher.js
/**
* react-router v8.4.0
*
* Copyright (c) Remix Software Inc.
...
*/
//#endregion
//#region node_modules/react-router/dist/development/lib/router/navigation.js
/**
* react-router v8.4.0
*
* Copyright (c) Remix Software Inc.
...
function useDataRouterFetchers(hookName) {
	let fetchers = import_react.useContext(FetchersContext);
...
var MANIFEST_RELOAD_TIMEOUT = 5e3;
var pendingManifestReload;
...
function useFetchers() {
	...
	return import_react.useMemo(() => Array.from(fetchers.entries()).map(([key, fetcher]) => ({
		...fetcher,
		key
	})), [fetchers]);
}
